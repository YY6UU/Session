...
async def generate_session(bot, msg, telethon=False):
    await msg.reply(
        "**- استخـراج كـود {} بواسطـة 𝗞𝗮𝗶𝗱𝗼 جـارٍ...**".format(
